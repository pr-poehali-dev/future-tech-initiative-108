...
const steps = [
  {
    ...
    description: "Загляните в каталог и найдите то, что отзовётся именно вам — серьги, кольцо, колье или браслет.",
  ...
  },
  {
    ...
    description: "Добавьте украшение в корзину и оставьте контакты — мы свяжемся, чтобы подтвердить детали и доставку.",
  ...
  {
    number: "03",
    title: "Получите и сияйте",
    description: "Бережно упакуем заказ и доставим по всей России. Останется только надеть и ловить восхищённые взгляды.",
  ...
  return (
    <section className="py-24 bg-black relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-6">Как сделать заказ</h2>
          <p className="text-xl text-gray-400 max-w-3xl mx-auto">
            Три простых шага от выбора украшения до счастливой улыбки в зеркале.
          </p>
        </motion.div>
